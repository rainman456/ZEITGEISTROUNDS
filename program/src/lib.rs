...
pub mod state;
pub mod utils;
pub mod contexts;  // ✅ Add contexts module
pub mod instructions;

declare_id!("24nBY5NPLcDBLzxDR3Av2NJpxsRRfDGv4KwZ9KB7vbpT");

#[program]
pub mod zeitgeist {  // ✅ Changed from my_program to match package name
    use super::*;
    ...
    pub fn create_round(
        ctx: Context<contexts::CreateRound>,
        round_id: u64,
        start_time: i64,
        end_time: i64,
        num_outcomes: u8,
    ...
    pub fn place_prediction(
        ctx: Context<contexts::PlacePrediction>,
        round_id: u64,
        outcome: u8,
        amount: u64,
    ) -> Result<()> {
    ...
    pub fn close_betting(ctx: Context<contexts::CloseBetting>, round_id: u64) -> Result<()> {
        instructions::close_betting::handler(ctx, round_id)
    }

    /// Settle a round with the winning outcome (admin only)
    pub fn settle_round(
        ctx: Context<contexts::SettleRound>,
        round_id: u64,
        winning_outcome: u8,
    ...
    pub fn claim_winnings(ctx: Context<contexts::ClaimWinnings>, round_id: u64) -> Result<()> {
        instructions::claim_winnings::handler(ctx, round_id)
    }

    /// Create a new tournament
    pub fn create_tournament(
        ctx: Context<contexts::CreateTournament>,
        tournament_id: u64,
        entry_fee: u64,
        max_rounds: u8,
        start_time: i64,
    ...
    pub fn emergency_cancel(
        ctx: Context<contexts::EmergencyCancel>,
        round_id: u64,
        reason: String,
    ) -> Result<()> {
